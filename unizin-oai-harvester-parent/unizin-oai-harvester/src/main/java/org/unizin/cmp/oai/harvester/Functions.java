...
public final class Functions {
     ...
     */
    @FunctionalInterface
    public static interface CXRunnable {
     ...
     */
    @FunctionalInterface
    public static interface CXConsumer<T> {
     ...
     *         exceptions.
     */
    public static Runnable wrap(final CXRunnable runnable) {
        return () -> {
            try {
                runnable.run();
     ...
     */
    public static <T> Runnable wrap(final CXConsumer<T> consumer, final T t) {
        return wrap(() -> consumer.apply(t));
    }

    public static <T> Consumer<T> wrap(final CXConsumer<T> consumer) {
        return t -> {
            try {
               consumer.apply(t);
            } catch (final Exception e) {
